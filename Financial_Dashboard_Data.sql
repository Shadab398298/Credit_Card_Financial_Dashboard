...
COPY cc_detail
FROM 'C:\Documents\DataAnalyst(Udemy)\04_Power BI(Udemy)\Project (Credit card weekly dashboard)\Data\credit_card.csv' 
DELIMITER ',' 
CSV HEADER;
...
COPY cust_detail
FROM 'C:\Documents\DataAnalyst(Udemy)\04_Power BI(Udemy)\Project (Credit card weekly dashboard)\Data\customer.csv' 
DELIMITER ',' 
CSV HEADER;
